...
(function() {
    $('body').append(`<div style="position: fixed; z-index: 999; left: 1%; bottom: 3%; font-size: 25px; text-align: center;"><a href="${window.location.href.replace("_fl.pdf","_ut.pdf")}" target="_blank" style="text-decoration: none;" title="Megnyitás új ablakban">🔮</a><hr><a style="text-decoration: none; cursor: pointer;" id="splits" title="Oldalfelezés ki-be">📄📄</a></div>`);
